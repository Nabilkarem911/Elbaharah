...
const form = reactive({ username: '', full_name: '', password_hash: '', role: 'cashier', is_active: true });
...
const openModal = (row = null) => {
  ...
  else { editing.value = false; Object.assign(form, { username: '', full_name: '', password_hash: '', role: 'cashier', is_active: true }); }
